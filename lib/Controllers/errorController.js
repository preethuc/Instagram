...
var handleJwtTokenExpire = function handleJwtTokenExpire() {
  return new AppError("Token has been expired!.Please register again", 401);
};

var handleMulterError = function handleMulterError() {
  return new AppError("Please select only one image", 400);
};

var handleWebTokenError = function handleWebTokenError() {
